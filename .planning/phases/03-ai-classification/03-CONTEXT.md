...
- **D-02:** Process pages sequentially with a delay between requests to avoid hitting rate limits. Use the existing per-page progress caching to resume on failure.
